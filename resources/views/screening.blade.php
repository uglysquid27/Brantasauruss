...
@section('content')
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            screeningForm.addEventListener("submit", function (event) {
                ...
                if (batukValue === "ya" && bbValue === "ya" && demamValue === "ya") {
                    ...
                    const modal = new bootstrap.Modal(document.getElementById('tbIndicationModal'));
                    modal.show();
                }
            });
    ...
    <!-- Modal -->
    <div class="modal fade" id="tbIndicationModal" tabindex="-1" aria-labelledby="tbIndicationModalLabel"
        aria-hidden="true">
    ...
    <section class="bg-white min-h-screen flex items-center justify-center p-8 py-40"
        style="font-family: 'Poppins', sans-serif;">
        <div class="w-full max-w-4xl bg-[#f7c1d9] p-10 rounded-lg shadow-lg border-4 border-black">
            <form action="/screening/store" method="POST" enctype="multipart/form-data" id="screeningForm"
                class="space-y-6">
                {{ csrf_field() }}
                ...
                <div id="personalInfoSection">
                    ...
                    <div class="flex justify-center mt-8">
                        <button type="button" id="nextButton"
                            class="bg-[#a0f0c5] text-black font-bold py-3 px-8 border-2 border-black relative group">
                            Next
                            <div
                                class="absolute top-1 left-1 bg-black w-full h-full z-0 transition-all duration-300 group-hover:top-0 group-hover:left-0 rounded">
                            </div>
                        </button>
                    </div>
                </div>
                ...
                <div id="screeningFormSection" style="display: none;">
                    <h2 class="text-3xl font-bold text-center text-black mb-6">Screening Form</h2>
                    ...
                    <div class="space-y-6">
                        ...
                        @foreach ($questions as $name => $label)
                            <div class="text-center">
                                ...
                                <div class="flex justify-center gap-6 checkbox-group">
                                    <label class="flex items-center gap-2">
                                        <input type="checkbox" name="{{ $name }}" value="ya" class="checkbox checkbox-success">
                                        Ya
                                    </label>
                                    <label class="flex items-center gap-2">
                                        <input type="checkbox" name="{{ $name }}" value="tidak"
                                            class="checkbox checkbox-success"> Tidak
                                    </label>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="flex justify-between mt-8">
                        <button type="button" id="prevButton"
                            class="bg-gray-300 text-black font-bold py-3 px-8 border-2 border-black rounded-lg hover:bg-gray-400">
                            Previous
                        </button>

                        <button type="submit"
                            class="bg-green-400 text-black font-bold py-3 px-8 border-2 border-black rounded-lg hover:bg-green-500">
                            Submit
                        </button>
                    </div>
                </div>
